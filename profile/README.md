...
## What can I do?
We encourage help from the University and wider community; after all we are a student led body that runs services and events for students by students, we need all the help we can get. If you want to help out with one of our on going projects, feel free to [get in touch](mailto:compsoc@socs.universityofgalway.ie) with us.  
...
## Security Notice
If you find an issue with any of our services that would not be considered serious, feel free to log an issue, else, please email [compsoc@socs.universityofgalway.ie](mailto:compsoc@socs.universityofgalway.ie).
